...
public class AppTests extends TestBase {
    ...
    @DisplayName("podlodka test")
    void generatedTest() {
        step("open https://podlodka.io/", () -> {
    ...
    void titleTest() {
        step("Open url 'https://podlodka.io/'", () ->
            open("https://podlodka.io/"));

        step("Page title should have text 'Podlodka Podcast'", () -> {
            String expectedTitle = "Podlodka Podcast";
